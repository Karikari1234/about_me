...
Tags: cookie banner, cookie consent, cookie plugin, gdpr, dsgvo, eprivacy, eu cookie law, cookie policy, cookie, consent, consent management
Stable tag: trunk
...
Obtain GDPR and ePrivacy Directive compliant consents. **Find services, cookies etc. and fill all legal information in your cookie banner.** More than just a cookie notice! Designed specifically for WordPress websites to simplify setup for website owners.
...
_Whether the use of the plugin leads to legally compliant data processing largely depends on whether the plugin is configured correctly for your use case. You yourself are responsible for a correct configuration. If you are unsure about legal questions, please contact your lawyer for legal advice._
...
**Customize design:** You can design the cookie banner according to your wishes. 20+ design presets and over 200 options give you the flexibility to customize the cookie banner perfectly to fit. From colors and effects to texts, you can let off steam creatively. All changes are shown in a live preview.
...
**Native in WordPress:** Real Cookie Banner is specially designed for WordPress. It is fully installed in your WordPress as native plugin. All consents are processed and stored on your server. Nothing is downloaded from a cloud in your visitor’s browser, which avoids further legal issues.
...
* **Explanations intuitively linked:** We explain legal and technical background knowledge in articles linked to the respective features.
...
* **Automatic video playback after consent:** If your visitor allows the loading of an external video only via a content blocker, he must start the video manually afterwards. We save him the click and start YouTube and Vimeo videos automatically.
...
_Only a few templates are included in the free version. But you are able to create every service by hand with the free version. Get the [PRO version of Real Cookie Banner](https://devowl.io/go/real-cookie-banner?source=wordpress-org-description) to access all templates._

**Cookie templates**

* [ActiveCampaign](https://www.activecampaign.com/)
* [AddThis](https://www.addthis.com/)
* [AddToAny (WordPress Plugin)](https://www.addtoany.com/)
* [Adobe Fonts (Typekit)](https://fonts.adobe.com/)
* [Amazon Associates (Widget)](https://affiliate-program.amazon.com/)
* [Analytify](https://analytify.io/)
* [Anchor.fm](https://anchor.fm/)
* [Apple Music](https://support.apple.com/en-ke/guide/music-web/apdm0783785d/web)
* [Bing Maps](https://www.bing.com/maps/embed-a-map)
* [Bloom](https://www.elegantthemes.com/plugins/bloom/)
* [CleanTalk Spam Protection](https://wordpress.org/plugins/cleantalk-spam-protect/)
* [Cloudflare](https://www.cloudflare.com/)
* [Custom Facebook Feed](https://wordpress.org/plugins/custom-facebook-feed/)
* [Custom Twitter Feeds (Tweets Widget)](https://wordpress.org/plugins/custom-twitter-feeds/)
* [Discord](https://discord.com/)
* [Elementor](https://elementor.com/)
* [ExactMetrics (Universal Analytics)](https://www.exactmetrics.com/)
* [Ezoic](https://www.ezoic.com/)
* [Facebook (Like)](https://developers.facebook.com/docs/plugins/like-button/)
* [Facebook (Post)](https://developers.facebook.com/docs/plugins/embedded-posts/)
...
* [Feeds for YouTube](https://wordpress.org/plugins/feeds-for-youtube/)
* [Flickr (Images)](https://www.flickr.com/)
* [Font Awesome (via several CDNs)](https://fontawesome.com/)
* [Found.ee DMP Pixel](https://found.ee/super)
* [Freshchat](https://www.freshworks.com/live-chat-software/)
* [GA Google Analytics (Universal Analytics & Analytics 4)](https://wordpress.org/plugins/ga-google-analytics/)
* [Google Ads](https://ads.google.com/)
* [Google AdSense](https://www.google.com/adsense)
* [Google Analytics (Universal Analytics & Analytics 4)](https://analytics.google.com/)
...
* [Helpcrunch (Chat)](https://helpcrunch.com/)
* [HelpScout (Chat)](https://www.helpscout.com/)
* [Hotjar](https://www.hotjar.com/)
* [Imgur](https://imgur.com/)
* [Instagram (Post)](https://www.instagram.com/)
* [Intercom (Chat)](https://www.intercom.com/customer-support-software)
* [Issuu](https://issuu.com/)
* [Jetpack Comments](https://jetpack.com/support/comments/)
* [Jetpack Site Stats](https://jetpack.com/features/traffic/site-stats/)
...
* [Matomo (Standalone installation and as WordPress plugin)](https://matomo.org/)
* [Matomo Tag Manager](https://matomo.org/docs/tag-manager/)
* [Metricool](https://metricool.com/)
* [Microsoft Advertising Universal Event Tracking (UET) Tag (Bing Ads)](https://ads.microsoft.com/)
* [Microsoft Clarity](https://clarity.microsoft.com/)
* [MonsterInsights (Universal Analytics)](https://www.monsterinsights.com/)
* [Mouseflow](https://mouseflow.com/)
* [MyFonts](https://www.myfonts.com/)
* [Paddle.com](https://paddle.com/)
* [Pinterest (Embed)](https://www.pinterest.com/)
...
* [Proven Expert (Widget)](https://www.provenexpert.com/)
* [Quform](https://www.quform.com/)
* [RankMath Google Analytics (Universal Analytics)](https://rankmath.com/)
* [Reamaze (Chat)](https://www.reamaze.com/)
* [reddit](https://www.reddit.com/wiki/embeds)
...
* [Twitter (Tweet)](https://developer.twitter.com/en/docs/twitter-for-websites/embedded-tweets/overview)
...
* [WooCommerce Google Analytics Integration (Universal Analytics & Analytics 4)](https://wordpress.org/plugins/woocommerce-google-analytics-integration/)
* [WooCommerce Stripe Payment Gateway](https://wordpress.org/plugins/woocommerce-gateway-stripe/)
* [Wordfence](https://wordpress.org/plugins/wordfence/)
* [WordPress Comments](https://wordpress.org/support/article/comments-in-wordpress/)
* [WordPress Emojis](https://wordpress.com/support/emoji/)
* [WordPress User Login](https://wordpress.org/support/article/cookies/)
* [WPML](https://wpml.org/)
* [Yandex Metrica](https://metrica.yandex.com/)
* [YouTube](https://www.youtube.com/)
* [Zendesk Chat](https://www.zendesk.de/chat/)
...
* [Bing Maps](https://www.bing.com/maps/embed-a-map)
* [Bloom](https://www.elegantthemes.com/plugins/bloom/)
* [Caldera Forms with Google reCAPTCHA](https://github.com/andrewlimaza/caldera-forms-anti-spam)
* [CleverReach with Google reCAPTCHA](https://www.cleverreach.com/)
* [Contact Form 7 with Google reCAPTCHA](https://contactform7.com/recaptcha/)
* [Custom Facebook Feed](https://wordpress.org/plugins/custom-facebook-feed/)
* [Custom Twitter Feeds (Tweets Widget)](https://wordpress.org/plugins/custom-twitter-feeds/)
* [Discord](https://discord.com/)
* [ExactMetrics (Universal Analytics)](https://www.exactmetrics.com/)
...
* [Flickr (Images)](https://www.flickr.com/)
* [Font Awesome (via several CDNs)](https://fontawesome.com/)
* [Form Maker with Google reCAPTCHA](https://de.wordpress.org/plugins/form-maker/)
* [Formidable with Google reCAPTCHA](https://formidableforms.com/add-recaptcha-wordpress-contact-forms/)
* [GA Google Analytics (Universal Analytics & Analytics 4)](https://wordpress.org/plugins/ga-google-analytics/)
* [Google Analytics (Universal Analytics & Analytics 4)](https://analytics.google.com/)
* [Google Fonts](https://fonts.google.com/)
* [Google Maps](https://www.google.de/maps)
...
* [Mailchimp for WooCommerce](https://wordpress.org/plugins/mailchimp-for-woocommerce/)
* [MailerLite](https://www.mailerlite.com/)
* [Matomo (as WordPress plugin)](https://matomo.org/)
* [Metricool](https://metricool.com/)
* [MonsterInsights (Universal Analytics)](https://www.monsterinsights.com/)
* [MyFonts](https://www.myfonts.com/)
* [Ninja Forms with Google reCAPTCHA](https://ninjaforms.com/docs/plugin-settings/)
...
* [WooCommerce Google Analytics Integration (Universal Analytics & Analytics 4)](https://wordpress.org/plugins/woocommerce-google-analytics-integration/)
* [WordPress Emojis](https://wordpress.com/support/emoji/)
* [WPForms with Google reCAPTCHA](https://wpforms.com/docs/setup-captcha-wpforms/)
* [Yandex Metrica](https://metrica.yandex.com/)
* [YouTube](https://www.youtube.com/)
* [Zoho Bookings](https://www.zoho.com/bookings/)
* [Zoho Forms](https://www.zoho.com/forms/)
...
Legally, the obligation is based on the ePrivacy Directive ([Directive 2009/136/EC](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=celex%3A32009L0136)) Art. 66, which describes that the setting of cookies that are not strictly technically necessary requires the explicit consent of the user. The ePrivacy Directive has not yet been transposed into national law by a lot of EU countries (including German), but according to current legal opinion, it must be applied nevertheless. In addition, you need consent for the processing of personal data according to [Art. 6 GDPR](https://gdpr-info.eu/art-6-gdpr/).

Some German users will have [§ 15 para. 3 TMG](https://www.gesetze-im-internet.de/tmg/__15.html) as the German solution to the cookie issue in mind. The paragraph assumes that consent is granted automatically if the user does not object (opt-out procedure). However, the ECJ clarified on October 1, 2019 in [case C-673/17](http://curia.europa.eu/juris/document/document.jsf;jsessionid=D5DC4CA415C605B28E70747FD3C5158C?text=&docid=218462&pageIndex=0&doclang=DE&mode=req&dir=&occ=first&part=1&cid=1458627) that the German special way of an opt-out procedure is not in accordance with the ePrivacy Directive and since then, it must be assumed that only the opt-in procedure is permissible. This was also confirmed by the Federal Court of Justice for Germany on May 28, 2020 ([Case I ZR 7/16](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=I%20ZR%207/16) – Cookie Consent II).
...
A risk already exists today due to the ECJ decision of October 1, 2019 in [case C-673/17](http://curia.europa.eu/juris/document/document.jsf;jsessionid=D5DC4CA415C605B28E70747FD3C5158C?text=&docid=218462&pageIndex=0&doclang=DE&mode=req&dir=&occ=first&part=1&cid=1458627). We assume that the number of warnings will increase as soon as the ePrivacy Directive is replaced by the ePrivacy Regulation (ePVO). At the latest then, the risk of a warning should no longer be taken.
